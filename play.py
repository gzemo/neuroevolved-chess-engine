...
# past checkpoint (otherwise leave as None)
#PAST_GEN  = "02"
#PAST_SYN  = f"./population/pop{POPSIZE}_n{SINGLE_LAYER_N_NODES[0]}_m{NUMBER_OF_MATCHES}_d{MAX_DEPTH}_t{TIME_LIM}_g{PAST_GEN}_synapses.npy"
#PAST_BIAS = f"./population/pop{POPSIZE}_n{SINGLE_LAYER_N_NODES[0]}_m{NUMBER_OF_MATCHES}_d{MAX_DEPTH}_t{TIME_LIM}_g{PAST_GEN}_bias.npy"
#-----------------------------------------------------------
