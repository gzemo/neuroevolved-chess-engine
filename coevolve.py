...
# 	n_synapses=64*SINGLE_LAYER_N_NODES[0]+SINGLE_LAYER_N_NODES[0],
# 	n_bias=SINGLE_LAYER_N_NODES[0],
# 	weightmethod="unixavier", 
# 	cross_strategy="uniform")

# sp.update_fitness(np.random.randint(0,10, size=POPSIZE))

# sp._selection()
# print("Selection:\nparents:\n", sp.matrix[0:4,0:4])
# print("offsprings:\n", sp.offsprings[0:4,0:4])
# print("bias:\n", sp.bias[0:4,0:4])
# print("bias offsprings:\n", sp.bias_offsprings[0:4,0:4])
# print()
